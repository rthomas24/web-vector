...
// Markets module (news / SEC filings / calendar / sentiment / pulse). The facade, result types,
// renderers, tool metadata and catalog are on the root; helpers live on `webvector/markets`.
export type {
  CalendarEvent,
  CalendarOptions,
  CalendarResult,
