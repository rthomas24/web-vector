# WebVector — full guide

The long-form manual. The [README](../README.md) is the two-minute version; [CONFIGURATION](CONFIGURATION.md), [PROVIDERS](PROVIDERS.md) and [ARCHITECTURE](ARCHITECTURE.md) are the references.
...
Set the env var, name the provider, done. Details and gotchas per provider: [docs/PROVIDERS.md](PROVIDERS.md).
...
Repo layout and where to add things: [docs/ARCHITECTURE.md](ARCHITECTURE.md).
